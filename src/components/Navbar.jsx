      ...
      <div className="flex-1 max-w-xl">
        <div className="relative group">
          ...
          <input 
            ...
            className="w-full bg-slate-50 border-none rounded-xl pl-10 pr-4 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-500/10 transition-all font-medium"
          />
        </div>
      </div>
